...
![A quasar light curve with fitted slopes overlayed](/img/quasar_lc.pdf){:width="12.9cm"}
...
![Slope population for the above light curve.](/img/logs_hist.pdf){:width="12.9cm"}
...
![Tight correlation between variational slope (vertical axis) and absolute magnitude (horizontal axis).](/img/logs_vs_M_macho.pdf){:width="10.3cm"}
...
![Hubble diagram of the MACHO quasars showing very accurately our current model dependence.](/img/macho_consistency_DMplot.pdf){:width="12.9cm"}
